...
$url = $_GET['url'];
//$url = 'https://www.bikereg.com/api/EventSearch.aspx';
//$url = 'http://britishcycling.org.uk/events?search_type=upcomingevents&keywords=&resultsperpage=8000&series_id=&fromdate=29%2F04%2F2014&todate=&series_only=0&online_entry_only=0&distance=&postcode=';
...
if ( true ) {
  ...
  $contents = substr( $contents, strpos( $contents, '<!DOCTYPE html>' ) );
  print $contents;
  ...
  header( 'Content-type: application/x-javascript' ); //. ( $is_xhr ? 'json' : 'x-javascript' ) );
